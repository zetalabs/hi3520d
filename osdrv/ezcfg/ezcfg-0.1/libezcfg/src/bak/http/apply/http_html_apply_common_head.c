 ...
 * File Name    : http/apply/http_html_apply_common_head.c
 *
...
int ezcfg_http_html_apply_set_html_common_head(
	...
	int pi, int si)
{
	...
	ezcfg = ezcfg_http_html_apply_get_ezcfg(apply);
	html = ezcfg_http_html_apply_get_html(apply);
	...
	/* <link rel="stylesheet" type="text/css" href="/apply/layout_css" /> */
...
bool ezcfg_http_html_apply_set_http_html_common_header(struct ezcfg_http_html_apply *apply)
{
	...
	//ezcfg = ezcfg_http_html_apply_get_ezcfg(apply);
	http = ezcfg_http_html_apply_get_http(apply);
